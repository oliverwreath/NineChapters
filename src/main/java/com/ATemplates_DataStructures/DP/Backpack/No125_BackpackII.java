...
public class No125_BackpackII {
    private static final Logger logger = LoggerFactory.getLogger(No125_BackpackII.class);
    ...
    private void testNo125_BackpackII() {
        MyLogger.info("result 9 v.s. " + backPackII(10, new int[]{2, 3, 5, 7}, new int[]{1, 5, 2, 4}));
        MyLogger.info("result 11 v.s. " + backPackII(15, new int[]{2, 3, 5, 7}, new int[]{1, 5, 2, 4}));
    }

...
public class No29_InterleavingString {
    private static final Logger logger = LoggerFactory.getLogger(No29_InterleavingString.class);
    ...
    private void testNo29_InterleavingString() {
        MyLogger.info("result true v.s. " + isInterleave("aabcc", "dbbca", "aadbbcbcac"));
        MyLogger.info("result false v.s. " + isInterleave("aabcc", "dbbca", "aadbbbaccc"));
    }

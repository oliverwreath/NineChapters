...
public class DynamicProgrammingSolutions {
  ...
  public static class PathSolutions {
    ...
    public int jump(int[] A) {
      ...
      if (IS_TESTING) {
        for (int i = 0; i < n - 1; i++) {
          log.debug("jumpResults[i]={}", jumpResults[i]);
        }
      }
      // answer
  ...
  private static class SubSequenceSolutions {
    ...
    public int longestIncreasingSubsequence(int[] nums) {
      ...
      for (int x = 1; x < n; x++) {
        ...
        if (IS_TESTING) {
          log.debug(longestBy[x] + "_" + longestBy[x]);
        }
      }
  ...
  public static void main(String[] args) {
    ...
    dict.add("lint");
    dict.add("code");
    log.debug(s.substring(1, 4));
    log.debug("new PalindromSolutions().wordBreak(s, dict)={}", new PalindromSolutions().wordBreak(s, dict));

//        int[] A = new int[]{5,4,1,2,3};
//        log.debug(new SubSequenceSolutions().longestIncreasingSubsequence(A));
//        int[] B = new int[]{4,2,4,5,3,7};
//        log.debug(new SubSequenceSolutions().longestIncreasingSubsequence(B));
...
//        grid[0] = new int[]{0, 2};
//        grid[1] = new int[]{-1, 0};
//        log.debug(new PathSolutions().minPathSum(grid));

//        log.debug(new PathSolutions().uniquePaths(3, 62));

//        log.debug(new PathSolutions().climbStairs(0));
//        log.debug(new PathSolutions().climbStairs(1));
//        log.debug(new PathSolutions().climbStairs(2));
//        log.debug(new PathSolutions().climbStairs(3));
//        log.debug(new PathSolutions().climbStairs(4));

//        int[] A = new int[]{2,3,1,1,4};
//        log.debug(new PathSolutions().canJump(A));
//        int[] B = new int[]{3,2,1,0,4};
//        log.debug(new PathSolutions().canJump(B));
//        int[] C = new int[]{13,52,42,21,58};
//        log.debug(new PathSolutions().canJump(C));

//        int[] A = new int[]{2,3,1,1,4};
//        log.debug(new PathSolutions().jump(A));
//        int[] B = new int[]{3,2,1,0,4};
//        log.debug(new PathSolutions().jump(B));
//        int[] C = new int[]{13,52,42,21,58};
//        log.debug(new PathSolutions().jump(C));
  }
}

...
//    generateEmail(numberOfLines);
  ...
  private static void generateEmail(int numberOfLines) throws NoSuchAlgorithmException {
    List<String> endings = List.of("yahoo.ca", "outlook.com", "hotmail.com", "gmail.com", "msn.com", "icloud.com",
        "live.com", "yahoo.com");
    List<String> beginnings = List.of("barnetwang", "wilsonm", "gatorli", "wildixon", "harpes", "boftx", "bhima",
        "stakasa", "slaff", "alhajj", "gboss", "amaranth", "nachbaur", "jginspace", "flaviog", "thehuang124", "gommix",
        "durist", "sscorpio", "afeldspar", "carmena", "granboul", "euice", "skaufman", "rupak", "cliffordj", "jbuchana",
        "matloff", "cvrcek", "ilial", "meder", "bmidd", "nasor", "mxiao", "okroeger", "comdig", "lishoy", "jespley",
        "speeves", "osaru", "bryam", "ganter", "rafasgj", "jgmyers", "webinc", "esokullu", "landscape29380", "janneh",
        "neonatus", "fviegas", "mecchiel", "dbanarse", "storerm", "denton", "epeeist", "jgwang", "keijser", "pkilab",
        "bdbrown", "jaffe", "skoch", "mosses", "josephw", "isaacson", "chunzi", "tonyhe143", "ahmad", "fwitness",
        "dalamb", "greear", "jesse", "tangsh", "valdez", "hyper", "damian", "munson", "rhavyn", "jyoliver", "heewong23",
        "johnbob", "ramollin", "onestab", "solomon", "moxfulder", "mrobshaw", "imightb", "bjornk", "tubesteak", "burns",
        "muzzy", "kjetilk", "mcnihil", "warrior", "doormat", "haddawy", "vlefevre", "qrczak", "rfisher", "campware",
        "jonas", "njpayne", "shang", "szymansk", "bader", "wkrebs", "hmbrand", "gemmell", "uncled", "jdray", "treeves",
        "natepuri", "dieman", "sonnen", "farber", "amichalo", "dunstan", "gastown", "dcoppit", "pavel", "smpeters",
        "ijackson", "draper", "hachi", "lstein", "kannan", "ranasta", "djupedal", "dsowsy", "jfmulder", "skythe",
        "seano", "feamster", "fukuchi", "satch", "kaiser", "specprog", "jbailie", "cgreuter", "mchugh", "marnanel",
        "srour", "gravyface", "firstpr", "tmccarth", "naoya", "symbolic", "gward", "ghaviv", "guialbu", "schwaang",
        "grolschie", "danneng", "chrwin", "benanov", "majordick", "stecoop", "bogjobber", "fudrucker", "fatelk",
        "garland", "notaprguy", "drolsky", "citadel", "inico", "chronos", "godeke", "mlewan", "ebassi", "sacraver",
        "zilla", "intlprog", "mcmillan", "zeller", "geoffr", "alastair", "podmaster", "joehall", "malattia", "phizntrg",
        "library", "fangorn", "msloan", "psharpe", "aschmitz", "melnik", "nacho", "helger", "jandrese", "bradl");
...
//      log.debug("{}", incomeDecimal);
      long incomeLong = (long) incomeDecimal;
//      log.debug("{}", incomeLong);
      if (incomeLong < 10000) {
  ...
  private static void generatePhoneNumbers(final int numberOfLines, final String pattern,
      final int lengthOfMaskingEnding) throws ParseException, NoSuchAlgorithmException {
    ...
    for (int i = 0; i < numberOfLines; i++) {
      ...
      log.debug(phoneNumberFormatted.substring(0, phoneNumberFormatted.length() - lengthOfMaskingEnding) + "**");
    }
  }
}

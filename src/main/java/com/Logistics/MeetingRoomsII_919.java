 ...
 * SPACE: O(?)
 */
public class MeetingRoomsII_919 {
    private static final Logger logger = LoggerFactory.getLogger(MeetingRoomsII_919.class);

    public static void main(String[] args) {
        MeetingRoomsII_919 thisClass = new MeetingRoomsII_919();
        thisClass.testNeedNumberOfTrucks();
    }

    private void testNeedNumberOfTrucks() {
//        logger.info("result {} v.s. {}", "0", minMeetingRooms(Collections.EMPTY_LIST));
//        List<Interval> list = new LinkedList<>();
//        list.add(new Interval(0, 30));
//        list.add(new Interval(5, 10));
//        list.add(new Interval(15, 20));
//        logger.info("result {} v.s. {}", "2", minMeetingRooms(list));
//        list.add(new Interval(8, 12));
//        logger.info("result {} v.s. {}", "3", minMeetingRooms(list));
    }
    ...
    public int minTablesRequired(List<Interval> intervals) {
        ...
        Collections.sort(list, (o1, o2) -> (o1.time == o2.time) ? o1.flag - o2.flag : o1.time - o2.time);
